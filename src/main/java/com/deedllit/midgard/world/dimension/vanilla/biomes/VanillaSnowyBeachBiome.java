...
public class VanillaSnowyBeachBiome extends Biome {
	public VanillaSnowyBeachBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.SAND_SAND_GRAVEL_CONFIG)
				.precipitation(Biome.RainType.SNOW).category(Biome.Category.BEACH).depth(0.0F).scale(0.025F)
				.temperature(0.05F).downfall(0.3F).waterColor(4020182).waterFogColor(329011).parent((String) null));
		this.addStructure(
