...
public class VanillaModifiedJungleBiome extends Biome {
	public VanillaModifiedJungleBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				...
				.temperature(0.95F).downfall(0.9F).waterColor(4159204).waterFogColor(329011).parent("vanilla_jungle_biome"));
		this.addStructure(
