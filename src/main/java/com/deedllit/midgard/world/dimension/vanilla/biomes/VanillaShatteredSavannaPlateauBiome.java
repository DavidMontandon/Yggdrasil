...
public class VanillaShatteredSavannaPlateauBiome extends Biome {
	public VanillaShatteredSavannaPlateauBiome() {
		super((new Biome.Builder())
				.surfaceBuilder(SurfaceBuilder.SHATTERED_SAVANNA, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				.precipitation(Biome.RainType.NONE).category(Biome.Category.SAVANNA).depth(0.3625F).scale(1.225F)
				.temperature(1.1F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent("vanilla_savanna_biome"));
		this.addStructure(
