...
public class VanillaMountainEdgeBiome extends Biome {
	public VanillaMountainEdgeBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				.precipitation(Biome.RainType.RAIN).category(Biome.Category.EXTREME_HILLS).depth(0.8F).scale(0.3F)
