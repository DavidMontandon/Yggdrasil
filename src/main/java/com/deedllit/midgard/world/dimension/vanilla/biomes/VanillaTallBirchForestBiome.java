...
public class VanillaTallBirchForestBiome extends Biome {
	public VanillaTallBirchForestBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				.precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(0.2F).scale(0.4F)
				.temperature(0.6F).downfall(0.6F).waterColor(4159204).waterFogColor(329011).parent("vanilla_birch_forest_biome"));
		this.addStructure(
