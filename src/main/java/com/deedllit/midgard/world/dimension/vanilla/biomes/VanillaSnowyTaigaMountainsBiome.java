...
public class VanillaSnowyTaigaMountainsBiome extends Biome {
	public VanillaSnowyTaigaMountainsBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				...
				.temperature(-0.5F).downfall(0.4F).waterColor(4020182).waterFogColor(329011).parent("vanilla_snowy_taiga_biome"));
		this.addStructure(
