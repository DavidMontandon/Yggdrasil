...
public enum MidgardBiomeEdgeLayer implements ICastleTransformer {
	...
	public int apply(INoiseRandom context, int north, int west, int south, int east, int center) {
		...
		if (this.replaceBiomeEdge(outBiomeId, north, west, south, east, center,
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer MIDGARD_TROPICAL_ISLAND_BIOME <---> VANILLA_DEEP_WARM_OCEAN_BIOME" );
		...
		if (this.replaceBiomeEdge(outBiomeId, north, west, south, east, center,
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer MIDGARD_VOLCANIC_ISLAND_BIOME <---> VANILLA_DEEP_LUKE_WARM_OCEAN_BIOME" );
		...
		if (this.replaceBiomeEdge(outBiomeId, north, west, south, east, center,
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer MIDGARD_CHARPARRAL_TROPICAL_BIOME <---> VANILLA_JUNGLE_EDGE_BIOME" );
		...
		if (this.replaceBiomeEdgeIfNecessary(outBiomeId, north, west, south, east, center,
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer MOUNTAINS <---> MOUNTAIN_EDGE" );
		...
		if (this.replaceBiomeEdge(outBiomeId, north, west, south, east, center,
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer WOODED_BADLANDS_PLATEAU <---> BADLANDS" );
		...
		if (this.replaceBiomeEdge(outBiomeId, north, west, south, east, center,
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer BADLANDS_PLATEAU <---> BADLANDS" );
		...
		if (this.replaceBiomeEdge(outBiomeId, north, west, south, east, center,
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer GIANT_TREE_TAIGA <---> TAIGA" );
		...
		if (center == DESERT && (north == SNOWY_TUNDRA || east == SNOWY_TUNDRA
			...
			Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer DESERT <---> SNOWY_TUNDRA INTO WOODED_MOUNTAINS" );
			...
			if (center == SWAMP) {
				if (north == DESERT || east == DESERT || west == DESERT || south == DESERT
					...
					Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer SWAMP <---> DESERT/SNOWY_TUNDRA into PLAINS" );
				...
				if (north == JUNGLE || south == JUNGLE || east == JUNGLE || west == JUNGLE
					...
					Yggdrasil.LOGGER.info("MidgardBiomeEdgeLayer : Edge Layer SWAMP <---> JUNGLE/JUNGLE_HILLS into JUNGLE_EDGE" );
