...
public class VanillaGiantTreeTaigaBiome extends Biome {
	public VanillaGiantTreeTaigaBiome() {
		super((new Biome.Builder())
				.surfaceBuilder(SurfaceBuilder.GIANT_TREE_TAIGA, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				.precipitation(Biome.RainType.RAIN).category(Biome.Category.TAIGA).depth(0.2F).scale(0.2F)
