...
public class VanillaGiantSpruceTaigaHillsBiome extends Biome {
	public VanillaGiantSpruceTaigaHillsBiome() {
		super((new Biome.Builder())
				...
				.temperature(0.25F).downfall(0.8F).waterColor(4159204).waterFogColor(329011)
