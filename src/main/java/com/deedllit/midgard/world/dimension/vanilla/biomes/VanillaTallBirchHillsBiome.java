...
public class VanillaTallBirchHillsBiome extends Biome {
	public VanillaTallBirchHillsBiome() {
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				.precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(0.55F).scale(0.5F)
				.temperature(0.6F).downfall(0.6F).waterColor(4159204).waterFogColor(329011)
				.parent("vanilla_birch_forest_hills_biome"));
		this.addStructure(
