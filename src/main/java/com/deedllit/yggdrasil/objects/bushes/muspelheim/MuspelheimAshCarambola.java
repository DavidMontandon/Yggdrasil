package com.deedllit.yggdrasil.objects.bushes.muspelheim;
...
public class MuspelheimAshCarambola extends BushBlock implements IGrowable, DoNotCreateItem {
	...
	public static final IntegerProperty AGE = BlockStateProperties.AGE_0_3;
	   ...
	   public MuspelheimAshCarambola(Block.Properties properties) {
	      super(properties);
	...
	public ActionResultType onBlockActivated(BlockState p_225533_1_, World p_225533_2_, BlockPos p_225533_3_, PlayerEntity p_225533_4_, Hand p_225533_5_, BlockRayTraceResult p_225533_6_) {
	      ...
	      if (!flag && p_225533_4_.getHeldItem(p_225533_5_).getItem() == Items.BONE_MEAL) {
	         ...
	         spawnAsEntity(p_225533_2_, p_225533_3_, new ItemStack(BlockInit.MUSPELHEIM_ASH_CARAMBOLA_BUSH.get()	, j + (flag ? 1 : 0)));
