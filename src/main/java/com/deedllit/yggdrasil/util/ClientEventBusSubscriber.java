...
public class ClientEventBusSubscriber {
	...
	public static void clientSetup(FMLClientSetupEvent event) {
		...
		RenderTypeLookup.setRenderLayer(BlockInit.MIDGARD_RICE_BOTTOM_CROP.get(), RenderType.getCutout());		
		RenderTypeLookup.setRenderLayer(BlockInit.PISTIA_WATER_LETTUCE.get(), RenderType.getCutout());		
		//RenderTypeLookup.setRenderLayer(BlockInit.MIDGARD_RICE_TOP_CROP.get(), RenderType.getCutout());		
		
		//RenderTypeLookup.setRenderLayer(BlockInit.DESERT_GRASS, RenderType.getCutout());		
