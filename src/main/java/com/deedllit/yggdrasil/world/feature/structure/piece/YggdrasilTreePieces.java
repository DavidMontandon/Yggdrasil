...
public class YggdrasilTreePieces {
    ...
    public static void register() {
        JigsawManager.REGISTRY.register(new JigsawPattern(new ResourceLocation(Yggdrasil.MOD_ID, "castles"), 
        		new ResourceLocation("yggdrasil_tree"), ImmutableList.of(Pair.of(new SingleJigsawPiece(Yggdrasil.MOD_ID + ":yggdrasil_tree"), 1)), 
    ...
    public static void generate(ChunkGenerator generator, TemplateManager templateManager, BlockPos position, List<StructurePiece> pieces, SharedSeedRandom random) {
        JigsawManager.addPieces(new ResourceLocation(Yggdrasil.MOD_ID, "castles"), 7, YggdrasilTreePiece::new, generator, templateManager, position, pieces, random);
    }
