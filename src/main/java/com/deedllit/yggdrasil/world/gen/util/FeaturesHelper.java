package com.deedllit.yggdrasil.world.gen.util;
...
public class FeaturesHelper {
    ...
    public static BlockClusterFeatureConfig createClusterConfiguration(BlockState state) {
        return (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(state), new SimpleBlockPlacer())).tries(64).().build();
    }
    ...
    public static BlockClusterFeatureConfig createClusterConfigurationDoubleWater(BlockState state) {
        return (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(state), new DoublePlantBlockPlacer())).replaceable().tries(64).noProjection().build();
    }
    */
