...
public class AsgardExtremeMoutainBiome extends Biome {

	public AsgardExtremeMoutainBiome() {
	      super((new Biome.Builder()).surfaceBuilder(SurfaceBuilderInit.FLOATING_ISLAND_EXTREME_MOUTAIN, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
