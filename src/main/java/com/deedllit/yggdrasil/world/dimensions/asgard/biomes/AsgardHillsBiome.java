...
public class AsgardHillsBiome extends Biome {

	public AsgardHillsBiome() {
	      ...
	      AsgardDefaultBiomeFeatures.addSparseAshTrees(this);
	      AsgardDefaultBiomeFeatures.addSparseElmTrees(this);
