...
public abstract class SvartalvheimSurfaceBuilder<C extends ISurfaceBuilderConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<SurfaceBuilder<?>> {
	   ...
	   public static final SurfaceBuilder<SurfaceBuilderConfig> SVARTALVHEIM_CAVERN = register("yggdrasil:svartalvheim_cavern", new SvartalvheimCavernBuilder(SurfaceBuilderConfig::deserialize));
