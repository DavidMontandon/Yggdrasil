...
public class NifelheimChunkGenerator extends NoiseChunkGenerator<NifelheimGenSettings> {
	...
	public NifelheimChunkGenerator(IWorld worldIn, BiomeProvider provider, NifelheimGenSettings settingsIn) {
