...
public class AsgardSnowyTaigaMountainsBiome extends Biome {
	public AsgardSnowyTaigaMountainsBiome() {
		super((new Biome.Builder())
				.surfaceBuilder(SurfaceBuilderInit.FLOATING_ISLAND_EXTREME_MOUTAIN, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
