...
public class MuspelheimSkyRender implements IRenderHandler {
    public static final MuspelheimSkyRender INSTANCE = new MuspelheimSkyRender();

    private static final float DARKNESS_RED = 250.5F / 255.0F;
    private static final float DARKNESS_GREEN = 10.0F / 255.0F;
    private static final float DARKNESS_BLUE = 10.0F / 255.0F;
