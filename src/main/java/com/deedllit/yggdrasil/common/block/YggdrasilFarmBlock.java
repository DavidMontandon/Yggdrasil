...
public class YggdrasilFarmBlock extends FarmlandBlock {

	private static Tag<Fluid> fluidTag ; 
	private static BlockState turnIntoBlock ; 
	
	public YggdrasilFarmBlock(Properties builder, Tag<Fluid> fluid, BlockState turnInto) {
		super(builder);
		YggdrasilFarmBlock.fluidTag = fluid ; 
		YggdrasilFarmBlock.turnIntoBlock = turnInto ; 
	}
	...
	public static void turnToDirt(BlockState state, World worldIn, BlockPos pos) {
		worldIn.setBlockState(pos, nudgeEntitiesWithNewState(state, YggdrasilFarmBlock.turnIntoBlock, worldIn, pos));
	}
