...
public class YggdrasilBaneBlock extends FourWayBlock {
	public YggdrasilBaneBlock(Block.Properties builder) {
	   ...
	   public final boolean canAttachTo(BlockState state, boolean p_220112_2_) {
