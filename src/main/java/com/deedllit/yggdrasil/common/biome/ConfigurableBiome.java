...
public interface ConfigurableBiome {
    ...
    void placeFeatures(GenerationStage.Decoration stage, YggdrasilChuckGenerator generator, WorldGenRegion world, long seed, SharedSeedRandom random, BlockPos origin);
