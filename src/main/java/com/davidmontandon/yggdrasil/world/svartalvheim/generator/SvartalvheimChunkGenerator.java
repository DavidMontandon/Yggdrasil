...
public class SvartalvheimChunkGenerator extends NoiseChunkGenerator<SvartalvheimCaveGenSettings> {

	   private final double[] field_222573_h = this.func_222572_j();

	   public SvartalvheimChunkGenerator(World p_i48694_1_, BiomeProvider p_i48694_2_, SvartalvheimCaveGenSettings p_i48694_3_) {
